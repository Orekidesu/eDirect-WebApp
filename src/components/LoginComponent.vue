...
<template>
  <div class=" w-screen h-screen  ">
    <section class="h-screen  flex items-center justify-center">
      <div
        class="flex flex-col items-center justify-center px-6 py-8 mx-auto  border rounded-lg shadow dark:border border-gray-200 ">
...
const handleLogin = () => {
  ...
  // If validation is successful, redirect to dashboard
